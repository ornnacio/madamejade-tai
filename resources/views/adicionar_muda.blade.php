				...
				<div class="form-group">
					<div class="row">
						<div class="col">
							...
							<input type="date" class="form-control" name="data_plantação" required>
						</div>
						<div class="col">
							<label>Data de Germinação</label>
							<input type="date" class="form-control" name="data_germinação" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<input class="form-control" name="número_filhas" placeholder="Número de filhas" required>
				</div>
